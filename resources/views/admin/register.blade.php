                ...
                <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                    <div class="card-body p-5">
                        <div class="text-center mb-4">
                            <h1 class="h3 text-gray-900 fw-bold">Create an Account</h1>
                            <p class="text-muted">Please fill in your information</p>
                        </div>

                        <form action="{{ route('registerUp') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                        ...
                        <div class="text-center text-muted">
                            <small>Already have an account? <a href="{{ route('login') }}">Login here</a></small><br>
